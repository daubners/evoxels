...
class VoxelFields:
    ...
    def __init__(self, num_x: int, num_y: int, num_z: int, spacing):
        """
        Initializes the voxel grid with specified dimensions and spacing.
    ...
    def plot_slice(self, fieldname, slice_index, direction='z', colormap='viridis'):
        """
